    ...
    <body>
        <header>
            <nav class="navbar">
                ...
                <div>
                    <ul class="list">
                        <li><a href="usuario?ubicacion=homeI">Inicio</a></li>
                        <li><a href="usuario?ubicacion=usuarioT">Usuario</a></li>
                        <li><a href="usuario?ubicacion=consultarI">Consultar Usuarios</a></li>
                        <li><a href="publicacion?accion=consultarI">Consultar Publicacion</a></li>
                      </ul>
                </div>
            </nav>
        </header>
